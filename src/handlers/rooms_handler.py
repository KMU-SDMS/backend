...
from src.dto import RoomListDTO
...
def get_all(event, context):
    ...
    rooms_data, err = rooms_service.get_all_rooms()
    ...
    # DTO를 사용하여 응답 데이터 변환
    room_list_dto = RoomListDTO.from_supabase_data(rooms_data)
    return responses.create_success_response(room_list_dto.to_dict())
